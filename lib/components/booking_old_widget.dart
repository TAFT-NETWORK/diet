                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'lj6614xp' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown(
                      options: [
                        FFLocalizations.of(context).getText(
                          'zf8xc7f4' /* Type of Appointment */,
                        ),
                        FFLocalizations.of(context).getText(
                          '9m6bnr03' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'gmcjih58' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          '1ujnngsp' /* Scan/Update */,
                        )
                      ],
