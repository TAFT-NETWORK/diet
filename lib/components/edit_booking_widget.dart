          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'ilbqej1i' /* Edit the fields below in order... */,
                        ),
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'dvgatqhg' /* Emails will be sent to: */,
                  ),
                  style: FlutterFlowTheme.of(context).bodyText1,
                ),
              ),
              ...
              Padding(
                ...
                child: FlutterFlowDropDown(
                  ...
                  options: [
                    FFLocalizations.of(context).getText(
                      '9vq5pp0v' /* Type of Appointment */,
                    ),
                    FFLocalizations.of(context).getText(
                      't8lzh90x' /* Doctors Visit */,
                    ),
                    FFLocalizations.of(context).getText(
                      'se3ch9ul' /* Routine Checkup */,
                    ),
                    FFLocalizations.of(context).getText(
                      'k5mn2jre' /* Scan/Update */,
                    )
                  ],
