              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'edwgk3nn' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'pqfmpnny' /* Emails will be sent to: */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText1,
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown(
                      options: [
                        FFLocalizations.of(context).getText(
                          'adf9smef' /* Type of Appointment */,
                        ),
                        FFLocalizations.of(context).getText(
                          'j33qufrs' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'x4x4wmba' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          '285x204f' /* Scan/Update */,
                        )
                      ],
